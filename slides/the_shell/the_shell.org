...
#+ATTR_LATEX: :options fontsize=\scriptsize
#+BEGIN_SRC bash
# Transform either foo or bar to FUBAR (note use of -E for extended regex)
...
#+ATTR_LATEX: :options fontsize=\scriptsize
#+BEGIN_SRC bash
# Put double quotes around instances of foo or bar using grouping
